...
setMethod(
  ...
  definition = function( is, output.dir="is", sr, counts, features, exons, mergedBams, jCompletelyIncluded = FALSE, zoomRegion = 1.5, useLog = FALSE, tcex = 1, ntop = NULL) {
    ...
    for(i in 1:ntop){
      ...
      tryCatch({
        ...
        .plotSplicingPattern(r, is, counts, features, mergedBams, sr, exons, genePlot = TRUE, jCompletelyIncluded, zoomRegion, useLog, tcex)
        dev.off()
        png(width = 1400, height=700, filename = paste0(getwd(), "/", output.dir, "/img/", r, ".png"))
        .plotSplicingPattern(r, is, counts, features, mergedBams, sr, exons, genePlot = FALSE, jCompletelyIncluded, zoomRegion, useLog, tcex)
        dev.off()
