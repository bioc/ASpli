...
setMethod(
  ...
  definition = function( is, output.dir="is", sr, counts, features, mergedBams, jCompletelyIncluded = FALSE, zoomRegion = 1.5, useLog = FALSE, tcex = 1, ntop = NULL, openInBrowser = F, makeGraphs = T,bforce=FALSE) {
