...
devtools::load_all("~/Documents/ASpli")
...
Note: for a large number of experimental units you might disable the generation of graphs setting the option \texttt{makeGraphs=FALSE} in \texttt{exportIntegratedSignals} function call.
